...
/****
*
* reference : https://github.com/mpdf/mpdf-examples/blob/development/example01_basic.php
* run time : 180.21328902245
* run time : 180.15005612373
****/
...
$logFileName = "log/".basename(__FILE__,'.php').'.log';
$myfile = fopen($logFileName, "w") or die("Unable to open file!");
fwrite($myfile, $time_elapsed_secs);
fclose($myfile);
